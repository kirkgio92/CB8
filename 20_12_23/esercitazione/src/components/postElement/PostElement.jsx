...
const PostElement = ({ postData }) => {
  ...
  return (
    <div className="PostElement">
      <div className="PostElement__user--Data">
        <img src={image} alt={image} />
        <h3>{firstName + " " + lastName}</h3>
      </div>
      <h3 className="PostElement__title">{title}</h3>
      <p className="PostElement__content">{body}</p>
      <div className="PostElement__likes--tags">
        <div className="PostElement__likes">
          <span>
            <svg
              fill="#000000"
              height="40px"
        ...
        <ul className="PostElement__tags">
          {tags.map((tag) => (
            <li key={tag}>{tag}</li>
          ))}
        </ul>
